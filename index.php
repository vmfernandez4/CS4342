            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="index.php" class="navbar-brand">
                  <div class="brand-text brand-big hidden-lg-down"><span>CS Inventory Team 6</span></div>
                  <div class="brand-text brand-small"><strong>Team6</strong></div></a>
      ...
      <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
          ...
          <div class="sidebar-header d-flex align-items-center">
            <div class="avatar"><img src="img/utep.jpg" alt="..." class="img-fluid rounded-circle"></div>
            <div class="title">
              <h1 class="h4">Team 6</h1>
              <p> Team 6 Dashboard</p>
            </div>
          </div>
          ...
          <ul class="list-unstyled">
            ...
            <li> <a href="tables.php"> <i class="icon-grid"></i>Adaptors</a></li>
        ...
        <div class="content-inner">
          ...
          <footer class="main-footer">
            <div class="container-fluid">
              <div class="row">
                <div class="col-sm-6">
                  <p>UTEP CS4342 Team 6  &copy; 2019</p>
                </div>
                <div class="col-sm-6 text-right">
                  <p>Design by <a href="https://bootstrapious.com/admin-templates" class="external">Team6</a></p>
